...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.184 (09-ene-2023 10.36) *** " ;
...
\ TODO:
\   Definir n! para asignar el nivel.
...
: NIVEL   ( n| -- ) 
    ...
    DEPTH 0> IF ELNIVEL ! TRUE REINICIAR ELSE VER-NIVELES THEN
;
