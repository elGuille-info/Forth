...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.113 (04-ene-2023 23.03) *** " ;
...
\ : QUEAYUDA-PRINT   QUE.AYUDA MAX_AYUDA -TRAILING TYPE ;
: QUEAYUDA-PRINT   *QUEAYUDA TYPE ;
...
: AYUDA-RUN  \ addr -- -1 si no se halló, si no, el índice 
    ...
    -1 > 
    IF
        \ cr ." antes del case en ayuda-run " .s cr
        ...
        ENDCASE
        \ cr ." despues del case en ayuda-run " .s cr
    THEN
...
: AYUDA-SEE
    ...
    *QUEAYUDA COMANDO-RUN
    \ Si es -1 es que no está esa palabra, buscar en los comandos
    -1 = 
    IF LIMPIAR-PILA 
        \ Esto buscará tanto ayuda xxx como xxx
        \ En el caso de NIVEL y DIFICULTAD solo debe tenerse en cuenta si se ha escrito ayuda
        *QUEAYUDA AYUDA-RUN 
    THEN
...
: DIME
    ...
    IF \ ." Es un numero"
        QUEAYUDA-TONUMBER
        \ ." despues de QUEAYUDA-TONUMBER en DIME: " .s CR
        DUP
        0= 
    ...
    ELSE \ ." No es un numero"
        ...
        \ por ahora solo se comprueba si el contenido de QUE.AYUDA es una de las ayudas
        \ 1 AYUDA-SEE
        \ Se comprueba primero si es una ayuda, si no, se comprueba si es un comando
        AYUDA-SEE
    THEN
;
