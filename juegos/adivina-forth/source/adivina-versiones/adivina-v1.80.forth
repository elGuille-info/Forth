...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina v1.80 (01-ene-2023 11.52) *** " ;
...
\	En DIFICULTAD si no se indica el número, mostrar el nivel de dificultad (DIFICULTAD-MOSTRAR).
...
\ NUMS+ se puede definir así
\ : NUMS+   ( INDEX# -- addr ) ARRAY.NUMS ;
...
: AYUDA-JUGAR
	DEPTH 0= IF CR ." La ayuda de JUGAR" CR CR ELSE DROP THEN
...
\ 	pero sigue siendo necesario comparar mayúsculas y minúsculas
: AYUDA-SEE
    QUE.AYUDA 40 -TRAILING
    \ Poner un 2DUP para cada comparación que se vaya a hacer menos una
    2DUP 2DUP 2DUP 2DUP 2DUP 2DUP 2DUP
    0 .AYUDAS COMPARE 0= 
    IF AYUDA-JUGAR
    ELSE 
        1 .AYUDAS COMPARE 0= 
