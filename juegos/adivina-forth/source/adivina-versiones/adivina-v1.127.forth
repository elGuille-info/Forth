...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.127 (06-ene-2023 00.35) *** " ;
...
\ TODO:
\   En DIME comprobar si se han escrito números y letras y en comprobar el comando hacerlo por las letras.
...
: COMANDO-RUN  \ addr -- -1 si no se halló, si no, el índice 
    ...
    IF
        ...
        CASE 
            ...
            0 OF QUENUMEROS-TONUMBER NIVEL 0 ENDOF
            1 OF QUENUMEROS-TONUMBER DIFICULTAD ENDOF
            2 OF PISTA ENDOF
            3 OF A-N? ENDOF
            4 OF RESUELVE ENDOF
            5 OF RES ENDOF
