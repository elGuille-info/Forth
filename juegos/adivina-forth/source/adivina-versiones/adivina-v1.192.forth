...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.192 (09-ene-2023 21.04) *** " ;
...
: $AYUDA   ( index -- addr len )
    ...
    ( el código si se define $Ayudas usando $"
    $AYUDAS SWAP CELLS + @ 
