...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.155 (07-ene-2023 16.44) *** " ;
...
\ TODO:
\   Al mostrar el nivel, indicar el rango del número a adivinar.
\       Lo mismo hay que comprobar antes si se está jugando.
...
: JUGAR
    ...
    \ SOLUCIONMOSTRADA @
    CR
    \ Aquí no se debe mostrar esta ayuda.
    \ \ No mostrar el título de AYUDA-JUGAR
    \ 1 AYUDA-JUGAR
;
...
: AYUDA-SEE
    ...
    -1 = 
    IF \ cr ." en AYUDA-SEE si habia algo en la pila " .s \ LIMPIAR-PILA 
