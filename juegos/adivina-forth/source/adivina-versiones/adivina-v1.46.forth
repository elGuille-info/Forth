...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.46 (28-dic-2022 20.12) " ;
...
: random2 ( n1 n2 -- n -> n será un número entre n1 y n2 inclusive )
...
: QUEDAN-INTENTOS
	...
	\ I.N @ MAX.INTENTOS @ >= 
	\ Aquí comprobar mayor, ya que se llega con el valor incrementado
	\ y puede ser que lo acierte en el último intento.
	\ I.N @ MAX.INTENTOS @ >
	I.N @ MAX.INTENTOS @ >= 
	IF ." Muchos intentos, la solucion es " NUM ? 
		\ v1.46 asignar a N.GUESS el número para que sea como adivinado
		\ N.GUESS no está definido aún
		NUM @ N.GUESS !
	ELSE
...
: ADIVINADO
	...
	\ CR ." I.N @ MAX.INTENTOS @ > " I.N @ MAX.INTENTOS @ > .
	\ CR ." N.GUESS @ NUM @ = " N.GUESS @ NUM @ = .
...
\ JUGAR-SOLO-DIFICIL para probar con nivel NIVEL.MAX - 2 a NIVEL.MAX y DIFICULTAD EXPERTO a MAESTRO
: JUGAR-SOLO-DIFICIL
	NIVEL.MAX 2 - NIVEL.MAX random2 EL-NIVEL !
	EXPERTO MAESTRO random2 NIVEL.D !
	JUGAR-SOLO
;
