...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.49 (28-dic-2022 22.20) " ;
...
: JUGAR-SOLO
	...
	\	Si se pasa el número de intentos, con > no muestra esto
	\	Si se pasa de intentos o lo adivina en el último intento, con >= muestra esto
	\ I.N @ MAX.INTENTOS @ >=
	\ v1.49 lo cambio a >
	I.N @ MAX.INTENTOS @ >
