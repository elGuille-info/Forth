...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.239 (14-ene-2023 08.59) *** " ;
...
\ TODO:
\   Definir $Dificultades usando $" y comprobar que no se usen arrays con s"
\   Definir clearstacks para SwiftForth
