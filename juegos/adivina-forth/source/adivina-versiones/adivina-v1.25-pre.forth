...
\ Adivinar un número v1.25 27-dic-2022 14.04

: VERSION   ." Adivina v1.25 (27-dic-2022 14.04) " ;
...
\ En realidad no es necesario usar un array
VARIABLE NIVELES 6 CELLS ALLOT

: NIVELES+ CELLS NIVELES + ;
: NIVELES.I   NIVELES+ 1 SWAP +! ; 
\ Asignar los valores de intentos en cada nivel de dificultad
: ASIGNAR-NIVELES 
	50 0 NIVELES+ !
	30 1 NIVELES+ !
	15 2 NIVELES+ !
...
\ Limpiar el contenido del array y asignar los valores de intentos por nivel.
NIVELES 7 CELL ERASE
ASIGNAR-NIVELES
