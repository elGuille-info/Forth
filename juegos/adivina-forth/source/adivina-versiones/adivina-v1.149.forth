...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.149 (07-ene-2023 12.56) *** " ;

\ v1.149 (07-ene-2023 12.56)
\   En DIFICULTAD-INDEX ya está arreglado y funciona con 0 dificultad y _experto dificultad.
...
\   Parece que ya va bien al indicar <NUMBER> DIFICULTAD, 07-ene-2023 11.37
...
: MOSTRAR-NUMS
    ...
    LOOP
    cr ." en MOSTRAR-NUMS, limpiar la pila? " .s
    LIMPIAR-PILA
;
