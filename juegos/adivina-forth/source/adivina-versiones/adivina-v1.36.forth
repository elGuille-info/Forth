...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.36 (28-dic-2022 15.15) " ;
...
: SHOW-INSTRUCCIONES 
	." Para jugar de nuevo escribe JUGAR y seguir con el mismo nivel. " CR
...
\ SOLO-EXPERTO Nivel 7 a 9 y EXPERTO (6 intentos) 
: SOLO-EXPERTO
	7 9 random2 EL-NIVEL !
	EXPERTO NIVEL.D !
	JUGAR-SOLO
;
\ SOLO-DIFICIL Nivel 7 a 9 y DIFICIL (9 intentos) 
: SOLO-DIFICIL
	7 9 random2 EL-NIVEL !
	DIFICIL NIVEL.D !
	JUGAR-SOLO
...
\ JUGAR-SOLO-AUTO elige al azar el NIVEL de juego entre 4 y 9 
\	y DIFICULTAD entre DIFICIL 9 y MAESTRO 5
: JUGAR-SOLO-AUTO
	( Elegir un nivel entre 4 y 9 )
	4 9 random2 EL-NIVEL !
	( Elegir un nivel de DIFICULTAD entre DIFICIL y MAESTRO)
	DIFICIL MAESTRO random2 NIVEL.D !
	JUGAR-SOLO
;

\ SOLO-MEDIO juega con un NIVEL entre 1 y 9 y con el nivel de DIFICULTAD MEDIO 14
: SOLO-MEDIO
	( Elegir un nivel entre 1 y 9 )
	1 9 random2 EL-NIVEL !
	( Usar el nivel de DIFICULTAD MEDIO 14 intentos )
	MEDIO DIFICULTAD
	JUGAR-SOLO
;

( 
	Pruebas para BEGIN / UNTIL y array con valores 
	Se necesitan las definiciones de:
	NUM, I.N, GUESS, HINT, STR y ADIVINADO
