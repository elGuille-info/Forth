...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.143 (06-ene-2023 15.26) *** " ;
...
: dificultades1-$   ( index -- string )
    $dificultades1 swap 2 cells * + 2@
;

: dificultades1-dump
    depth 0= if 80 then
    $dificultades1 swap dump
;
: addr-dump   ( addr n -- ) 
    depth 1 = if 80 then
    dump ;

: DIFICULTAD1-N   ( index -- num )
    \ offset 56 para el primer valor y 4 + para los siguientes
    \ 4 * 28 + $DIFICULTADES1 + @ ;
    4 * 56 + $DIFICULTADES1 + @ ;

: DIFICULTAD1-$   ( index -- str )
    DUP
    \ 2 * 1 - $DIFICULTADES1 4 + swap cells + @ count TYPE ."  "
    $dificultades1 swap 2 cells * + 2@ TYPE ."  "
    ." (" DIFICULTAD1-N . ." intentos) "
;

: las-dificultades1-nombres
    \ %DIFICULTADES 1 + 0 do I dificultad1-n STR I %DIFICULTADES < if ." , " then loop ;
    %DIFICULTADES 1 + 0 do I dificultades1-$ type I %DIFICULTADES < if ." , " then loop ;

: LAS-DIFICULTADES1
    ."    "
    %DIFICULTADES 1 + _SENCILLO DO I . ." = " I DIFICULTAD1-$ ."  " 
...
: DIFICULTAD-$   ( index -- string )
    ...
    CASE 
        ...
        _SENSEI    OF ." _SENSEI " ENDOF
    ENDCASE
    ." (" DIFICULTAD-N . ." intentos) "
;

CREATE $DIFICULTADES2
    $" _ALEATORIO" , 15 , 
    $" _SENCILLO" , 22 ,
    $" _MEDIO" , 14 ,
    $" _DIFICIL" , 12 ,
...
: DIFICULTAD2-N   ( index -- num )
    8 * 4 + $DIFICULTADES2 + @ ;

: DIFICULTAD2-$   ( index -- str )
    DUP
    2 * 1 - $DIFICULTADES2 4 + swap cells + @ count TYPE ."  "
    ." (" DIFICULTAD2-N . ." intentos) "
;
...
: LAS-DIFICULTADES
    ...
    %DIFICULTADES 1 + _SENCILLO DO I . ." = " I DIFICULTAD-$ ."  " 
    \ I 1 + 3 MOD 0= IF CR ."    " THEN
...
CREATE $COMANDOS-TEXT
    ...
    \ $" para cambiar el nivel de DIFICULTAD a 1- _SENCILLO." , 
    \ $" para cambiar el nivel de DIFICULTAD a 2- _MEDIO." , 
    \ $" para cambiar el nivel de DIFICULTAD a 3- _DIFICIL." , 
    \ $" para cambiar el nivel de DIFICULTAD a 4- _EXPERTO." , 
    \ $" para cambiar el nivel de DIFICULTAD a 5- _MAESTRO." , 
    \ $" para cambiar el nivel de DIFICULTAD a 6- _SENSEI." , 
...
: COMANDO-RUN  \ addr -- -1 si no se halló, si no, el índice 
    \ aquí no llega cuando se indica <_NOMBRE> DIFICULTAD
    CR *QUENUMEROS TYPE ." " *QUELETRAS TYPE CR
    COMANDO-INDEX
    DUP
    \ Si devuelve -1 es que no existe ese comando, devolver -1
    -1 > 
    IF
        ...
        \ Comprobar primero si se indica el número de la dificultad con letras
        DUP
        CASE
            \ SENCILLO 22, MEDIO 14, DIFICIL 12, EXPERTO 9, MAESTRO 6, SENSEI 5
            7 OF S" 22" *QUENUMEROS QUENUMEROS! ENDOF
            8 OF S" 14" *QUENUMEROS QUENUMEROS! ENDOF
            9 OF S" 12" *QUENUMEROS QUENUMEROS! ENDOF
            10 OF S" 9" *QUENUMEROS QUENUMEROS! ENDOF
            11 OF S" 6" *QUENUMEROS QUENUMEROS! ENDOF
            12 OF S" 5" *QUENUMEROS QUENUMEROS! ENDOF
        ENDCASE
