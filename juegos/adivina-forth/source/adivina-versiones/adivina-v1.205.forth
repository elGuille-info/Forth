...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.205 (11-ene-2023 08.58) *** " ;
...
\ Estas 2 definiciones funcionan igual
VARIABLE QUEAYUDA MAX_AYUDA ALLOT

\ Esto no funciona al unir cadenas
\ CREATE QUEAYUDA MAX_AYUDA CHARS ALLOT

\ Esto en principio funciona igual, salvo cuando se van a unir las cadenas
\   no si se definen QUENUMEROS y QUELETRAS de la misma forma
...
: QUEAYUDA-UNIR-ANT   ( -- )
    ...
    'QUENUMEROS BOUNDS ?DO I c@ QUEAYUDAPOS @ c! QUEAYUDAPOS @ 1 + QUEAYUDAPOS ! LOOP
    cr ." 2-queayudapos @ " queayudapos ?
    s"  " drop c@  QUEAYUDAPOS @ c! QUEAYUDAPOS @ 1 + QUEAYUDAPOS !
    cr ." 3-queayudapos @ " queayudapos ?
    'QUELETRAS BOUNDS ?DO I c@ QUEAYUDAPOS @ c! QUEAYUDAPOS @ 1 + QUEAYUDAPOS ! LOOP
