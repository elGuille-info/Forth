...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.254 (16-ene-2023 08.03) *** " ;
...
:NONAME
    ...
    CAMBIARJUEGO?
    IF
        s" en jugar-bucle cambiarjuego? es true " DEBUG1
        FALSE TO CAMBIARJUEGO?
        DUP
        CASE
            ...
            \ 8 OF -1 SWAP ENDOF
        ENDCASE
        CR ." Se cambia el tipo de juego." CR CR
        EXIT
    THEN
...
:NONAME
    ...
    \ Asignar false si es -1 u 8, true en otro caso
