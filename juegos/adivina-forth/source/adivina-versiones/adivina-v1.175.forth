...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.175 (08-ene-2023 20.13) *** " ;
...
\   Añado el comando D! como alias de DIFICULTAD en $COMANDOS.
...
: AYUDA-INDEX   ( addr -- index|-1 )
    cr ." al entrar en ayuda-index " .s \ flag? addr len
    \ Esto lo hace bien
    \ 2>R -1 2R>
    \ cr ." en ayuda-index despues de 2>R -1 2R> " .s
    ...
    DO 
        ...
        \ esto dejaría -1 -1 len
        \ IF 2>R I 2R> LEAVE THEN
        IF 
        ...
        IF 
            cr ." en ayuda-index, en el if del do " .s 
            2>R I 2R> 
            cr ." en ayuda-index, en el if del do despues de 2>R I 2R> " .s 
            \ Esto no lo hace bien, parece ser que quita el valor de I
            \ 2>R drop I 2R> 
            2>R dup swap drop I 2R> 
            cr ." en aYuda-index, en el if del do, despues de 2>R dup swap drop I 2R>  " .s
            LEAVE
        THEN
        )
    LOOP
...
: AYUDA-RUN   ( addr -- index|-1 si no se halló )
    ...
    ELSE
        ...
        ELSE
            ...
            IF 
                ...
                s" )."
            ELSE
                \ ." Si asignas " DUP $DIFICULTAD TYPE ."  (" QUENUMEROS-TONUMBER STR ." ) "
...
: AYUDA-SEE   ( flag -- )
    ...
    \ No comprobar, dejar lo que hubiera
