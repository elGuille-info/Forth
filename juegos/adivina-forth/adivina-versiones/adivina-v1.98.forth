...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina v1.98 (02-ene-2023 22.24) *** " ;
...
: $AYUDA
    \ %AYUDAS min 1- $AYUDAS swap cells + @ 
    %AYUDAS min $AYUDAS swap cells + @ 
    count
;
\ : ?AYUDA   $AYUDA TYPE ;
...
\ Esto no funciona siempre devuelve la ayuda general
: AYUDA-SEE-CASE
    QUEAYUDA-TOUPPER
    QUE.AYUDA MAX_AYUDA -TRAILING
    2DUP 2DUP 2DUP 2DUP 2DUP
  	CASE 
  		1 .AYUDAS COMPARE 0= OF LIMPIAR-PILA AYUDA-JUGAR EXIT ENDOF
  		2 .AYUDAS COMPARE 0= OF LIMPIAR-PILA AYUDA-NIVEL EXIT ENDOF
  		3 .AYUDAS COMPARE 0= OF LIMPIAR-PILA AYUDA-DIFICULTAD EXIT ENDOF
  		4 .AYUDAS COMPARE 0= OF LIMPIAR-PILA AYUDA-PISTA EXIT ENDOF
  		5 .AYUDAS COMPARE 0= OF LIMPIAR-PILA AYUDA-ADIVINA EXIT ENDOF
  	ENDCASE
  	LIMPIAR-PILA AYUDA-GENERAL
;
