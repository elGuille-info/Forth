...
\ Adivinar un número v1.8 25-dic-2022 22.46

: VERSION   ." Adivina v1.8 (25-dic-2022 22.46) " ;
...
: NIVEL-NUMERO 
	." El nivel actual es: " EL-NIVEL ? ." Adivina un numero del 1 al " EL-NIVEL @ 100 * .
;
...
: HELP   
	...
	\ ."     El nivel actual es: " EL-NIVEL ? ." el numero sera del 1 al 100 " CR
	\ ."     El nivel actual es: " EL-NIVEL ? ." el numero sera del 1 al " EL-NIVEL @ 100 * . CR
	\ ( v1.8 Usar NIVEL-NUMERO para mostrar el nivel y el número )
	\ NIVEL-NUMERO CR
