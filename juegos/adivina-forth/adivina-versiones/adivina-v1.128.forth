...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.128 (06-ene-2023 01.07) *** " ;
...
\ TODO:
\   Si se escribe NIVEL desde DIME, preguntar si lo quiere cambiar ya que se reiniciará el juego.
    ...
    IF
        ...
        CASE
            ...
            0 OF 
                ...
                \ IF 2DROP NIVEL 0 ELSE SWAP DROP NIVEL 0 THEN
            ENDOF
