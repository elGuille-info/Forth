...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.222 (12-ene-2023 14.53) *** " ;
...
\ v1.221 si no se indica el parámetro, usar false
: AYUDA-BUSCAR   ( flag| -- )
    \ v1.221 si no se indica el parámetro, usar false
    DEPTH 0= IF FALSE THEN
    COMPROBARSEE !
    
    s" en ayuda-buscar antes de AYUDA?AYUDA " DEBUG1
    AYUDA?AYUDA
    s" en ayuda-buscar despues de AYUDA?AYUDA " DEBUG1
    -1 =
    IF
