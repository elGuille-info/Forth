...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.62 (29-dic-2022 18.05) " ;
...
\ TODO:
\	Definir AYUDA con opciones para ver qué se puede hacer, por ejemplo:
\		JUGAR AYUDA, NIVEL AYUDA, etc.
\		Poder hacerlo con AYUDA JUGAR, AYUDA NIVEL, etc.
\		Ver la definición de SEE de GFORTH:
(
: see
