...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.146 (06-ene-2023 16.37) *** " ;
...
: QUENUMEROS-TONUMBER   ( -- numero )
    ...
    *QUENUMEROS DIFICULTAD-INDEX -1 =
    ." QUENUMEROS-TONUMBER " .s
    IF *QUENUMEROS STR>INT THEN
;
...
:NONAME
    ...
    DO 
        ...
        IF 2DROP I .s LEAVE THEN
    LOOP
    ." DIFICULTAD-INDEX despues de LOOP " .s
