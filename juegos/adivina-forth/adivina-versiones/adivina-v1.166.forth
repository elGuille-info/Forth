...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.166 (08-ene-2023 03.03) *** " ;
...
\   Añadir a los comandos D! como alias de DIFICULTAD.
...
: MOSTRAR-NUMS ( -- )
    ...
    \ IF cr ." en MOSTRAR-NUMS hay mas datos en la pila que cuando se entro, se quita 1 " .s DROP THEN
    IF DROP THEN
;
...
: AYUDA-INDEX   ( addr -- index o -1 )
    ...
    DO 
        ...
        \ IF cr ." if " .s drop 2>R I 2R> ." antes de then " .s LEAVE THEN
        IF DROP 2>R I 2R> LEAVE THEN
    LOOP
    \ En la pila estará el valor del índice si se ha hallado, 
    \ si no, lo que hubiera en la pila y la dirección puesta al entrar
    \ cr ." en ayuda-index despues del loop " .s
    2DROP
    \ cr ." en ayuda-index despues del loop-2 " .s
    
    \ Cuando llegue aquí solo debe haber un valor en la pila
    \ Si hay más es que no se ha encontrado
    \ DEPTH 1 > IF LIMPIAR-PILA -1 THEN
    \ DEPTH 1 > IF cr ." en ayuda-index " .s -1 THEN
;
...
: AYUDA-RUN   ( addr -- -1 si no se halló, si no, el índice )
    ...
    AYUDA-INDEX
    \ cr ." al entrar en ayuda-run-despues de ayuda-index " .s
    DUP
    ...
    IF
        ...
        CASE
            ...
            0 OF 
                ...
                ELSE
                    ...
                    ELSE
                        ...
                        CONTINUAR?
                        \ cr ." si es NIVEL despues de CONTINUAR? " .s
                        IF NIVEL 0 ELSE DROP THEN
                        \ cr ." despues de CONTINUAR? y el IF " .s
                    THEN
                THEN
            ENDOF
            ...
            1 OF 
                QUENUMEROS-TONUMBER
                DUP
                \ cr ." En CASE DIFICULTAD cuando es 1 " .s
                NO_NUM =
            ...
            \ 6 OF AYUDA-DIME 6 ENDOF
            6 OF AYUDA-DIME ENDOF
        ENDCASE
    THEN
    \ cr ." al final de COMANDO-RUN " .s
;
...
: AYUDA-SEE   ( flag -- )
    ...
    \ CR ." Al entrar en AYUDA-SEE, despues de QUEAYUDA-TOUPPER " .s
    ...
    \ Ahora se comprueba el parámetro dejado en la pila
    \   Si es TRUE es que se deben comporobar los comandos y la ayuda
    \   Si es FALSE solo comprobar la ayuda
    ...
    IF
        ...
        *QUENUMEROS DIFICULTAD-INDEX -1 >
        ...
        THEN
        \ cr ." al final del if cuando es ayuda y comandos " .s
    ELSE
        \ cr ." se ha indicado false, se ha llamdo desde ayuda " .s
        \ DROP
        -1
    THEN
    ...
    IF
        ...
        \ cr ." antes de *QUEAYUDA AYUDA-RUN " .s
        *QUEAYUDA AYUDA-RUN
        \ cr ." despues de *QUEAYUDA AYUDA-RUN " .s
        ...
        -1 =
        IF  
            \ cr ." antes de QUEAYUDA-LENGTH 0> " .s
            ...
            \ COMPROBARSEE @
            \ R>
            \ el valor estará en la pila
            \ cr ." ande andara " .s
            IF CR AYUDA-DIME
            ELSE AYUDA-GENERAL
            THEN
        \ ELSE
        \    \ Quitar siempre lo que se quede en el return stack!
        \    \ R> DROP
        \    \ cr ." else ... " .s
        THEN
    THEN
...
:NONAME
    ...
    IF
        ...
        IF 
            ...
            \ cr ." en DIME depues de escribir 0 " .s
            ." Los numeros indicados son: " NUMS? CR 
            RESUELVE
            \ cr ." despues de escribir 0 " .s
            \ LIMPIAR-PILA
        ELSE
            ADIVINA
        THEN
...
:NONAME
    ...
    \ cr ." en ayuda antes de llamar a ayuda-see " .s
    FALSE AYUDA-SEE
; IS AYUDA
