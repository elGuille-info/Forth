...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.133 (06-ene-2023 05.34) *** " ;
...
: JUGAR
    ...
    1 AYUDA-PISTA
    ." Te ire preguntando el numero hasta que lo aciertes o no desees continuar."
    BEGIN
        LIMPIAR-PILA
        DIME
        SEGUIR-BUCLE
...
CREATE $COMANDOS-TEXT
    $" para mostrar o cambiar el NIVEL de juego." ,
