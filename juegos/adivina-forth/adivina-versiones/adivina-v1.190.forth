...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.190 (09-ene-2023 20.27) *** " ;
...
\ TODO:
\   Desde dime, cuando se escriba ayuda lo-que-sea mostrar siempre el título.
...
: COMANDO-RUN  ( addr len -- index|-1 )
    ...
    IF
        ...
        CASE
            ...
            6 OF DIFICULTAD-CASE ENDOF
            7 OF NIVEL-CASE ENDOF
        ENDCASE
    THEN
;
