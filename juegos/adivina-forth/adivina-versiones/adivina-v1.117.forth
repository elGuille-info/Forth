...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.117 (05-ene-2023 17.41) *** " ;
...
: LETRA?  \ nchar -- TRUE/FALSE
    DUP
    48 < 
    IF DROP TRUE EXIT THEN
    57 > IF TRUE EXIT THEN
    FALSE
;
...
: TIENE-LETRAS   \ addr len -- true o false
    \ CR ." antes de BOUNDS " .s
    BOUNDS
    \ CR ." despues de BOUNDS " .s CR
    DO 
        I C@ 
...
: *QUEAYUDA   QUE.AYUDA MAX_AYUDA -TRAILING ;

\ Devuelve TRUE o FLASE según tenga alguna letra
: QUEAYUDA-TIENE-LETRAS   *QUEAYUDA TIENE-LETRAS ;
