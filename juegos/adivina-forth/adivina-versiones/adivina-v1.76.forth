...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina v1.76 (31-dic-2022 19.15) *** " ;
...
: AYUDA-SEE
    ...
    2DUP 2DUP 2DUP 2DUP 2DUP 2DUP 2DUP \ 2DUP
    0 .AYUDAS COMPARE 0= 
    IF AYUDA-JUGAR
    ELSE 
        1 .AYUDAS COMPARE 0= 
            ...
            ELSE
                ...
                ELSE
                    ...
                    ELSE
                        ...
                        ELSE
                            6 .AYUDAS COMPARE 0= 
                            IF ." La ayuda de PISTA" CR CR AYUDA-PISTA
                            ELSE
                                7 .AYUDAS COMPARE 0= 
                                IF ." La ayuda de PISTA" CR CR AYUDA-PISTA
                                ELSE AYUDA-GENERAL
