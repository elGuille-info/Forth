...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.252 (15-ene-2023 20.16) *** " ;
...
CREATE $COMANDOS-TEXT
    ...
    $" para empezar con el tipo de juego elegido abandonando el actual." ,
...
: JUGAR-CAMBIAR   ( -- n|-1 )
    CR ." Elige que forma de jugar quieres." CR
    \ ." Escribe una de estas opciones para cambiar de juego."
    JUGAR-MOSTRAR-OPCIONES
    \ ." Si eliges una de estas opciones, se finaliza el juego actual." CR
    ...
    \ Si es 8 (?) seguir como hasta ahora.
    ...
    CASE
        ...
        8 OF -1 SWAP ENDOF
    ENDCASE
    s" en jugar-cambiar despues del ENDCASE " DEBUG1
