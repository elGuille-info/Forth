...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.214 (11-ene-2023 21.00) *** " ;
...
: AYUDA-SEE   ( -- )
    ...
    ELSE 
        ...
        IF
            ...
            DUP \ v1.214
            \ v1.214 si es -1 buscar lo que haya en quenumeros
            -1 =
            if
                s" en ayuda-see, QUENUMEROS= " 'QUENUMEROS cr DEBUG2
                'QUENUMEROS AYUDA-RUN
                s" en ayuda-see despues de 'QUENUMEROS AYUDA-RUN " cr DEBUG
            then
         THEN
    THEN
