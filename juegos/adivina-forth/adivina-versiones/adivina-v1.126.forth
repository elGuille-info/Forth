...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.126 (06-ene-2023 00.17) *** " ;
...
\   En MOSTRAR-NUMS / NUMS? limpiar la pila al salir.
...
: *QUENUMEROS   QUE.NUMEROS MAX_AYUDA -TRAILING ;
: *QUELETRAS   QUE.LETRAS MAX_AYUDA -TRAILING ;
: QUENUMEROS-LIMPIAR   *QUENUMEROS BOUNDS ?DO 32 I c! LOOP ;
: QUELETRAS-LIMPIAR   *QUELETRAS BOUNDS ?DO 32 I c! LOOP ;
: QUENUMEROS!   QUENUMEROS-LIMPIAR QUE.NUMEROS SWAP MOVE ;
: QUELETRAS!   QUELETRAS-LIMPIAR QUE.LETRAS SWAP MOVE ;
...
: COMANDO-RUN  \ addr -- -1 si no se halló, si no, el índice 
    ...
    IF
        ...
        CASE 
            ...
            0 OF QUEAYUDA-SPLIT QUENUMEROS-TONUMBER NIVEL ENDOF
            1 OF QUEAYUDA-SPLIT QUENUMEROS-TONUMBER DIFICULTAD ENDOF
            2 OF PISTA ENDOF
            3 OF A-N? ENDOF
            4 OF RESUELVE ENDOF
            5 OF RES ENDOF
    ...
    IF LIMPIAR-PILA 
        ...
        *QUEAYUDA AYUDA-RUN
        ...
        IF  
            ...
            ELSE AYUDA-GENERAL
            THEN
        \ ELSE \ Aquí llega si se ha ejecutado uno de los comandos o no se ejecutan comandos
        \   CR ." En AYUDA-SEE en la pila hay cosas si no es comando ni ayuda. " .s CR
        THEN
    THEN
...
: DIME
    ...
    ELSE
        \ v1.120 lo pongo dentro de AYUDA-SEE
        \ QUEAYUDA-TOUPPER
        LIMPIAR-PILA
