...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.120 (05-ene-2023 20.27) *** " ;
...
\ TODO:
\	Crear definición para comprobar si hay texto y números en QUE.AYUDA.
\		Si es así, asignar el número y la palabra por separado,
\			crear las variables QUE.NUM y QUE.PALABRAS.
    ...
    *QUEAYUDA COMANDO-RUN
    ...
    IF LIMPIAR-PILA 
        ...
        *QUEAYUDA AYUDA-RUN
        ...
        DEPTH 0= IF CR ." debe haber algo en la pila " .s CR THEN
        -1 =
