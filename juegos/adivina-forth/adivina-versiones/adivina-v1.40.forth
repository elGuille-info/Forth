...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.40 (28-dic-2022 17.54) " ;
...
\ Para probar los valores de la pila en random2
: random2? 
	." En random2? los valores de la pila son " .s CR
	OVER 
	." Despues de OVER los valores de la pila son " .s CR
	\ n2 n1 - 1 +
	- 1 + 
	." Despues de - 1 + los valores de la pila son " .s CR
	random
	." Despues de random los valores de la pila son " .s CR
	+ 
	." Despues de + los valores de la pila son " .s CR
;
: prueba-r2 
	CR ." Antes de random2? los valores de la pila son " .s CR
	5 15 random2?
	." Despues de random2? los valores de la pila son " .s CR
;

\ v1.14 Un número aleatorio entre los dos indicados, ambos inclusives
\ v1.40 quito las variables r1 y r2
\ VARIABLE r1 
\ VARIABLE r2
