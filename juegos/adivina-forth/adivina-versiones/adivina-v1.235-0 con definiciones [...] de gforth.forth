...
\ SwiftForth no tiene los [IF..] definidos, 13-ene-2023 17.57
\ Estas son las definiciones de gForth

[IFUNDEF] [THEN]
Defer [THEN]
\ : [THEN]  ; immediate
:NONAME   ; immediate IS [IFUNDEF]
[THEN]
...
: [IF]
  0=
  IF     countif off lookup @ 2141703180 ! [struct]-voc lookup !
  THEN
; immediate
[THEN]
...
\ : [IFUNDEF]
:NONAME
  POSTPONE [defined] 0=  POSTPONE [IF]
; immediate IS [IFUNDEF]
[THEN]
...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.235 (13-ene-2023 17.17) *** " ;
