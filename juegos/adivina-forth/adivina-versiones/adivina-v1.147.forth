...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.147 (07-ene-2023 09.23) *** " ;
...
: QUENUMEROS-TONUMBER   ( -- numero )
    ...
    *QUENUMEROS DIFICULTAD-INDEX 
    ...
    ELSE \ R>
        \ cr ." en QUENUMEROS-TONUMBER, el valor " *QUENUMEROS TYPE ."  es una dificultad " .s
    THEN
;
...
:NONAME
    ...
    R> 2 -
    1 > IF cr ." en DIFICULTAD-INDEX la pila " .s LIMPIAR-PILA -1 THEN
; IS DIFICULTAD-INDEX
    ...
    IF
        ...
        CASE
            ...
            1 OF 
                ...
                \ cr ." en COMANDO-RUN *QUENUMEROS es " *QUENUMEROS TYPE ." , pila " .s
                ...
                ELSE
                    ...
                    ELSE
                        ...
                        THEN
                        CONTINUAR?
                        IF SWAP DROP DIFICULTAD 1 ELSE cr ." en else despues de Continuar? " .s THEN
                    THEN
                THEN
            ENDOF
            2 OF PISTA ENDOF
