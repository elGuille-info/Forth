...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.219 (12-ene-2023 11.51) *** " ;
...
: QUELETRAS-SPLIT   ( -- )
    'QUELETRAS 32 $SPLIT QUENUMEROS! QUELETRAS!
;
...
: AYUDA?AYUDA   ( -- index|flag )
    ...
    IF
        ...
        0 >
        IF
            \ se puede haber escrito como ayuda ayuda-xxx
            \ comprobar si la segunda palabra está definida como ayuda
            \ \ Dividirlo poniendo la primera parte en números y la segunda en letras
            \ QUEAYUDA-SPLIT-NUMEROS-LETRAS
    ...
    IF DROP
        QUELETRAS-SPLIT
        'QUELETRAS AYUDA-RUN
        s"   en ayuda?ayuda despues del ultimo 'QUELETRAS AYUDA-RUN " DEBUG1
    ELSE
        DROP \ v1.218
        s"   en ayuda?ayuda despues del ultimo IF, en el ELSE " DEBUG1
    THEN
...
: AYUDA-SEE   ( -- )
    ...
    IF 
        ...
        TRUE AYUDA-BUSCAR 
    THEN
    s" en ayuda-see antes de salir y comprobar DEPTH " DEBUG1
