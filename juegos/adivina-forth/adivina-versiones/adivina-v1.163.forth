...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.163 (07-ene-2023 21.48) *** " ;

\ v1.163 (07-ene-2023 21.48)
\   En ayuda-see que siempre se indique algo en la pila.
\       TRUE o FALSE según se llame desde DIME o AYUDA respectivamente, 21.54
...
\ TODO:
\   Intentar quitar COMPROBARSEE, solo se usa en AYUDA-SEE.
...
\   TRUE si se llama desde AYUDA
\   FALSE si se llama desde DIME
: AYUDA-SEE   ( flag -- )
    COMPROBARSEE !
    ...
    IF
        ...
        *QUEAYUDA AYUDA-RUN
        ...
        THEN
    \ ELSE
    \     cr ." en AYUDA-SEE, esto no estaba, el ELSE del final... " .s
    THEN
