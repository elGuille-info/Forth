...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.50 (28-dic-2022 22.39) " ;
...
: SEGUIR-BUCLE
	...
	\ CR .s ." N.GUESS @ NUM @ = I.N @ MAX.INTENTOS @ > OR es " N.GUESS @ NUM @ = I.N @ MAX.INTENTOS @ > OR .
	N.GUESS @ NUM @ = I.N @ MAX.INTENTOS @ > OR
	\ CR .s ." SOLUCION-MOSTRADA OR " SOLUCION-MOSTRADA @ OR .
