...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina v1.106 (03-ene-2023 17.25) *** " ;
...
: DIFICULTADES-MOSTRAR
	...
	."    Escribe 0 DIFICULTAD (o 0 D!) para asignar un valor aleatorio entre _SENCILLO y _MAESTRO." CR
	LAS-DIFICULTADES CR
	...
	IF ."      " 
		...
		ELSE
			...
			IF ." Tienes el 50% de posibilidades de adivinarlo: "
				...
				." O es: " MENORINDICADO @ 1+ .
				." o es: " MAYORINDICADO @ 1- STR ." ."
			ELSE
