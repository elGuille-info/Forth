...
\ Adivinar un número v1.18 26-dic-2022 18.01

: VERSION   ." Adivina v1.18 (26-dic-2022 18.01) " ;
...
\ TODO:
\	Al mostrar los números hacerlo sin el espacio final o indicando el ancho máximo.
\		Para poder terminarlos con un punto.
