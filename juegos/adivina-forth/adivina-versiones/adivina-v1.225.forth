...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.225 (12-ene-2023 19.25) *** " ;
...
CREATE $AYUDAS
    ...
    \ s" AYUDA ADIVINA" 2,
    \ s" AYUDA FORTH" 2, \ 13
    s" INTERACTIVO" 2, \ 7 -- 14
    \ s" AYUDA INTERACTIVO" 2, \ 15
    s" JUGAR-INTERACTIVO" 2, \ 8 -- 16
    s" JUGAR INTERACTIVO" 2, \ 9 -- 17
    s" JUGANDO" 2, \ 10 -- 18
...
: AYUDA-RUN   ( addr len -- index|-1 )
    ...
    IF
        ...
        CASE 
            ...
            7 OF TRUE AYUDA-INTERACTIVO 7 ENDOF \ 14
            \ 15 OF TRUE AYUDA-INTERACTIVO 15 ENDOF
            8 OF TRUE AYUDA-INTERACTIVO 8 ENDOF \ 16
            9 OF TRUE AYUDA-INTERACTIVO 9 ENDOF \ 17
            \ Ayuda jugando no recibe el parámetro de mostrar título
            10 OF AYUDA-JUGANDO ENDOF \ 18
