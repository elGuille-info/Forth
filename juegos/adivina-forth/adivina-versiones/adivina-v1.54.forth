...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.54 (29-dic-2022 14.33) " ;
...
;
\ si juega la máquina
\ v1.54 MAQUINA? no se usa, lo quito, si hace falta usarlo comprobar que HUMANO? es false
\ : MAQUINA?   HUMANO? INVERT ;
...
: QUEDAN-INTENTOS
	...
	I.N @ MAX.INTENTOS @ >= 
	IF ." No quedan intentos, la solucion es " EL.NUM ? 
...
\ v1.54 G está definido en gForth para Android
\ : G  GUESS ;
: A-N   ADIVINA ;
\ v1.54 ADIVINA no se usa, se usa GUESS
\ : ADIVINA   GUESS ;
...
: REINICIAR 
	...
	\ \ después se asignará _HUMANO en JUGAR y _MAQUINA en JUGAR-SOLO
	\ 0 QUIEN.JUEGA !
