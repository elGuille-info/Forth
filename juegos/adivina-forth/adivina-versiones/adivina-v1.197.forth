...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.197 (10-ene-2023 08.52) *** " ;
...
: TIENE-LETRAS?   ( addr len -- flag )
    ...
    \ Esto falla si hay algo en la pila y no tiene letras
...
: QUEAYUDA-LENGTH   ( -- len ) *QUEAYUDA SWAP DROP ;
...
: QUEAYUDA-EMPIEZA-NUMERO   ( -- flag ) QUEAYUDA C@ DIGITO? ;
...
: QUENUMEROS-LENGTH   ( -- len ) *QUENUMEROS SWAP DROP ;
: QUELETRAS-LENGTH   ( -- len ) *QUELETRAS SWAP DROP ;
