...
\ TODO: 
\	Mostrar ayuda extra al usar GUESS y no adivinar el número.
\	Ahora muestra Tu numero es mayor / menor
\ 	Si había número anterior, mostrar algo así como:
\	El anterior (N.LAST) era menor/mayor
\	El penúltimo (N.ANT) era menor/mayor

\ Adivinar un número v1.13 26-dic-2022 11.28

: VERSION   ." Adivina v1.13 (26-dic-2022 11.28) " ;
...
: SHOW-CORRECTO   
	...
	." Para jugar de nuevo escribe RUN, JUGAR o INICIAR y seguir con el mismo nivel. " CR
