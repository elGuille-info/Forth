...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.63 (30-dic-2022 16.50) " ;
...
: AYUDAS  ( -- addr )
   C" JUGAR     jugar     NIVEL     nivel     DIFICULTADdificultad " ;
...
: AYUDA-GENERAL 
	...
	CR
	." Escribe AYUDA para ver esta ayuda." CR
	CR
	HELP1
;

: AYUDA-JUGAR
	." La ayuda de JUGAR" CR
	OPCIONES-SOLO
;
: AYUDA-NIVEL
...
: AYUDA-SEE   ( n -- mostrar la ayuda según el valor de la pila )
    ...
    \ son 3 palabras definidas, hacer copia de las 3
    2DUP 2DUP 2DUP
    \ Deja la dirección y la longitud en la pila
    CR
    0 .AYUDAS COMPARE 0= 
    IF AYUDA-JUGAR 2DROP 2DROP 2DROP \ 2DROP
    ELSE
        2DUP
        1 .AYUDAS COMPARE 0= 
        IF AYUDA-JUGAR 2DROP 2DROP 2DROP
        ELSE
            2 .AYUDAS COMPARE 0= 
            IF 
            	2DROP 2DROP
                ...
                ELSE
                    ...
                    ELSE 
                        ...
                        IF 
                        	...
                        	AYUDA-DIFICULTAD
                        ELSE
                            \ ." La ayuda de '" TYPE ."  ' no esta definida." CR
                            2DROP
                            AYUDA-GENERAL
                        THEN
                    THEN
