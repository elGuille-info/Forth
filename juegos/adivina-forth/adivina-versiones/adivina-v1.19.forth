...
\ Adivinar un número v1.19 26-dic-2022 18.46

: VERSION   ." Adivina v1.19 (26-dic-2022 18.46) " ;
...
\ TODO:
\	En HINT si al indicar el numero a adivinar esta entre n1 y n2, 
\		si n2-n1 = 2 mostrar: tienes el 50% de posibilidades de adivinarlo.
\		si n2-n1 = 1 mostrar: Si no lo adivinas ahora no se que hacer contigo.
\		si n2-n1 < 5 mostrar: que poquito te falta.
...
\	Si está entre 48 y 50, devolverá 2
: N.ENTRE   N.MAYOR @ N.MENOR @ - ;
...
: HUMOR-HINT 
	...
	N.POSIBLES 6 <
	IF ."      " 
		\ N.ENTRE 2 = ( solo tiene un número que poner, ej. está entre 15 y 17 ) 
		N.POSIBLES 1 = ( solo tiene un número que poner, ej. está entre 15 y 17 ) 
		IF ." Si no lo adivinas ahora no se que hacer contigo."
		ELSE
			\ N.ENTRE 3 = ( ej. está entre 15 y 18 solo tiene 2 números que probar )
