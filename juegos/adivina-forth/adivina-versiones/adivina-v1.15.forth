...
\ Adivinar un número v1.15 26-dic-2022 15.11

: VERSION   ." Adivina v1.15 (26-dic-2022 15.11) " ;
...
: HINT   
	...
	ELSE 
		...
		CR ." El menor más cercano es " N.MENOR ? 
		." El mayor más cercano es " N.MAYOR ?
	THEN
;
...
: REINICIAR 
	...
	( v1.15 asignar cero al menor y mayor más cercanos )
	0 N.MENOR ! 0 N.MAYOR !
	CR NIVEL-NUMERO
;
