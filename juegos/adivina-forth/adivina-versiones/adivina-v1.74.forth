...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina v1.74 (31-dic-2022 13.28) *** " ;
...
\	Dejo los nuevos intentos (que no funcionan) como AYUDA0 y AYUDA-SEE0
...
\ Poner 512 por si algún gracioso escribe chorradas
...
\ Definir la palabra AYUDA
: C-AYUDA 
    C" AYUDA-"
;
\ Esto toma la primera palabra de C-AYUDA, 
\   de forma que desde AYUDA-SEE se ponga AYUDA-LO_ESCRITO
: AYUDA- 
    0 *  C-AYUDA 1+  +  6 -TRAILING TYPE
;
\ Probar con AYUDA y lo que se haya escrito
: AYUDA-SEE0
	\ En realidad aquí no hay que hacer ninguna comprobación
	\	ya que si llega aquí es porque se ha escrito algo después de ayuda.
	\	Aunque fallará si se escribe ayuda-see :-P
    AYUDA- QUE.AYUDA 40 -TRAILING TYPE 
    CR
	
    \ Poner esta comprobación por si se escribe ayuda-see
    \ DEPTH 0=
    \ \ Si no hay nada en la pila, mostrar la ayuda general
    \ IF AYUDA-GENERAL
    \ ELSE
    \    \ Si hay algo en la pila, será lo que se ha escrito.
    \    \ AYUDA- pone en la consola AYUDA-
    \    \ QUE.AYUDA 40 -TRAILING TYPE pone en la consola lo que se ha escrito
    \    AYUDA- QUE.AYUDA 40 -TRAILING TYPE 
    \    CR
    \ THEN
;
...
: AYUDA0
    \ Comprobar si hay contenido en la pila
    DEPTH 0=
    \ Si no hay nada en la pila es que se ha escrito solo ayuda
    IF AYUDA-GENERAL
    ELSE
    	\ Comprobar si hay alguna definición de lo escrito
