...
\ Adivinar un número
: VERSION-ADIVINA   ." Adivina v1.35 (28-dic-2022 14.43) " ;
...
: JUGAR-AUTO
	...
	( Elegir un nivel de DIFICULTAD entre D.NORMAL y MASTER)
...
D.NORMAL DIFICULTAD ( v1.28 empezar con el nivel de dificultad D.NORMAL )
