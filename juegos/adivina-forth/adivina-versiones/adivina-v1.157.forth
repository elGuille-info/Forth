...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.157 (07-ene-2023 18.07) *** " ;
...
\   En JUGAR / DIME, si escribe resuelve no muestra ninguna ayuda.
...
\ TODO:
\   En COMANDO-RUN, si es NIVEL, mostrar el número del nivel actual,
\       si el que se indica es el mismo, nada que hacer.
