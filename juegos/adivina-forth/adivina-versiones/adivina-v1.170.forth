...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.170 (08-ene-2023 12.35) *** " ;
...
: QUENUMEROS-TONUMBER   ( -- numero )
    ...
    *QUENUMEROS DIFICULTAD-INDEX
    ...
    DUP
    -1 =
    \ IF DROP *QUENUMEROS STR>INT cr ." en QUENUMEROS-TONUMBER el valor es " *quenumeros type
...
: DIFICULTAD-CASE
    ...
    ELSE
        ...
        IF 
            ...
            SWAP DROP
            cr ." en dificultad-case, es el mismo nivel, tras SWAP DROP " .s
        ELSE
