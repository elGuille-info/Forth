...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.232 (13-ene-2023 08.39) *** " ;
...
\   En buscar-ayuda (y/o ayuda?ayuda) dividir queayuda por espacio 
...
: AYUDA-RUN   ( addr len -- index|-1 )
    ...
    \ 2DUP 2>R
    \ s"   al entrar en ayuda-run " 2R> DEBUG2 \ si se comenta esto, comentar lo anterior.
