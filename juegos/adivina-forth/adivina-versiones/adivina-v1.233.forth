...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.233 (13-ene-2023 09.09) *** " ;
...
: AYUDA-INDEX   ( addr len -- index|-1 )
    ...
    DO
        ...
        IF 
            ...
            \ s" en ayuda-index en el if " DEBUG1
            
            \ \ Quitar la addr len y el valor -1
            \ 2DROP DROP I AYUDATMP 2@
            
            \ No hace falta AYUDATMP, se quitan las 2 cosas que hay, 
...
: AYUDA-RUN   ( addr len -- index|-1 )
    ...
    IF
        ...
        CASE 
            ...
            \   pero es una ayuda.
            DROP -1
            s" en ayuda-run existe la ayuda, pero no se muestra, en el CASE " DEBUG1
        ENDCASE
