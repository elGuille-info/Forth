...
\ Adivinar un número
: VERSION-ADIVINA   ." *** Adivina Forth v1.212 (11-ene-2023 20.09) *** " ;
...
: AYUDA-BUSCAR   ( -- )
    ...
    IF  
        ...
        ELSE AYUDA-GENERAL
        THEN
        s" en ayuda-buscar NO existe la ayuda " cr DEBUG
    ELSE
...
: AYUDA-SEE   ( flag -- )
    ...
    IF
        ...
        (
        \ Esto buscará tanto ayuda xxx como xxx
        s" en ayuda-see antes de 'QUEAYUDA AYUDA-RUN, QUEAYUDA: " 'QUEAYUDA cr DEBUG2
        'QUEAYUDA AYUDA-RUN
        s" en ayuda-see despues de 'QUEAYUDA AYUDA-RUN " cr DEBUG
        
        DEPTH 0= 
        IF 
            CR ." ERROR debe haber algo en la pila en AYUDA-SEE despues de 'QUEAYUDA AYUDA-RUN " 
            .s CR 
            -1
        THEN
        \ Si queda -1 en la pila, es que no está esa ayuda
        ...
        IF  
            ...
            THEN
        ELSE
            s" en ayuda-see si existe la ayuda " cr DEBUG
        THEN
        )
    THEN
...
:NONAME
    ...
    QUEAYUDA-LEN 0=
    IF CR ." Por favor indica un numero, un comando o una ayuda." CR DIME THEN
